...
import { defineComponent, mergeProps, createVNode, resolveDynamicComponent, useSSRContext, ref, watch, unref, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, withDirectives, renderSlot, vShow, createCommentVNode } from "vue";
...
import { bc as useRoute, c as useRouter, bd as useLayoutConfigStore, be as isNavGroupActive, bf as layoutConfig, bg as getDynamicI18nProps, bh as getComputedNavLinkToProp, bi as isNavLinkActive, bj as until, bk as useEventListener, aX as themeConfig } from "../server.mjs";
import _sfc_main$7 from "./NavbarThemeSwitcher-C6RXK2Po.js";
import _sfc_main$8 from "./UserProfile-MTJs3d-E.js";
import { c as canViewNavMenuGroup, a as can, _ as _sfc_main$6 } from "./I18n-B80ZCpjQ.js";
        ...
        navbar: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              createVNode(VSpacer),
              unref(themeConfig).app.i18n.enable && unref(themeConfig).app.i18n.langConfig?.length ? (openBlock(), createBlock(_sfc_main$6, {
                key: 0,
                languages: unref(themeConfig).app.i18n.langConfig
