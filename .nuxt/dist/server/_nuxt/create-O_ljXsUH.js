import { defineComponent, computed, ref, mergeProps, withCtx, createVNode, toDisplayString, createTextVNode, withDirectives, openBlock, createBlock, Fragment, renderList, vShow, createCommentVNode, useSSRContext } from "vue";
...
import { b as VProgressCircular, a as VIcon, V as VBtn, aY as _export_sfc } from "../server.mjs";
...
import { a as VImg, V as VAvatar } from "./VAvatar-Bov4ZLUZ.js";
        ...
        _push(ssrRenderComponent(VCard, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`</div><div class="student-meta-info d-flex align-center gap-3 text-body-2" data-v-05d73627${_scopeId}><span class="font-weight-medium text-high-emphasis" data-v-05d73627${_scopeId}>${ssrInterpolate(currentStudent.value.name)}</span><span class="text-medium-emphasis" data-v-05d73627${_scopeId}>•</span><span class="text-medium-emphasis" data-v-05d73627${_scopeId}>${ssrInterpolate(classSession.value?.name || "DPS-Adaptive8C")}</span><span class="text-medium-emphasis" data-v-05d73627${_scopeId}>•</span><span class="text-medium-emphasis" data-v-05d73627${_scopeId}>${ssrInterpolate(currentStudent.value.bookTitle)}</span></div></div><span class="text-body-2 text-medium-emphasis" data-v-05d73627${_scopeId}> Mon, June 22, 2026 - 13:30 </span></div>`);
            } else {
              return [
                createVNode("div", {
                  class: "report-document-preview border rounded-lg d-flex flex-column align-center justify-center py-16 bg-light-gray mb-4",
                ...
                createVNode("div", { class: "preview-card-footer d-flex align-center justify-space-between px-5 py-3 rounded-lg bg-light-gray" }, [
                  createVNode("div", { class: "d-flex align-center gap-3" }, [
                    ...
                    createVNode("div", { class: "student-meta-info d-flex align-center gap-3 text-body-2" }, [
                      ...
                      createVNode("span", { class: "text-medium-emphasis" }, toDisplayString(classSession.value?.name || "DPS-Adaptive8C"), 1),
                      createVNode("span", { class: "text-medium-emphasis" }, "•"),
