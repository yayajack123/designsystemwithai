import { ref, createVNode, defineComponent, unref, withCtx, toDisplayString, createTextVNode, withModifiers, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate } from "vue/server-renderer";
import { m as genericComponent, o as propsFactory, F as useRender, N as makeComponentProps, u as useNuxtApp, aU as useAuthStore, c as useRouter, aV as themeConfig, V as VBtn, n as navigateTo } from "../server.mjs";
...
import { c as createForm, b as makeFormProps, V as VTextField } from "./VTextField-jMGfwBDn.js";
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(VCardText, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<h4 class="text-h4 mb-1"${_scopeId4}> Welcome to ${ssrInterpolate(unref(themeConfig).app.title)}! 👋🏻 </h4><p class="mb-0"${_scopeId4}> Please sign-in to your account and start the adventure </p>`);
                            } else {
                              return [
                                createVNode("h4", { class: "text-h4 mb-1" }, " Welcome to " + toDisplayString(unref(themeConfig).app.title) + "! 👋🏻 ", 1),
