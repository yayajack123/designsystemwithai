import { defineComponent, h, Transition, useSSRContext, ref, provide, watch, createVNode, resolveDynamicComponent, mergeProps, unref, withCtx, openBlock, createBlock, Fragment, renderList, createCommentVNode, renderSlot, withDirectives, vShow, inject, TransitionGroup, createTextVNode, toDisplayString, computed, toRef, resolveComponent } from "vue";
import { ssrRenderVNode, ssrRenderSlot, ssrRenderComponent, ssrRenderList, ssrRenderAttrs, ssrInterpolate, ssrRenderStyle, ssrRenderClass } from "vue/server-renderer";
import { aY as _export_sfc, u as useNuxtApp, ba as storeToRefs, aW as useAuthStore, bo as useElementHover, bp as injectionKeyIsVerticalNavHovered, bd as useLayoutConfigStore, bc as useRoute, bf as layoutConfig, c as useRouter, be as isNavGroupActive, bq as openGroups, bg as getDynamicI18nProps, br as useWindowSize, bs as useToggle, bt as syncRef, bh as getComputedNavLinkToProp, bi as isNavLinkActive, a as VIcon, aX as themeConfig } from "../server.mjs";
import _sfc_main$9 from "./NavBarNotifications-CBiSFxoh.js";
import _sfc_main$8 from "./NavbarThemeSwitcher-C6RXK2Po.js";
import _sfc_main$a from "./UserProfile-MTJs3d-E.js";
import { c as canViewNavMenuGroup, a as can, _ as _sfc_main$7 } from "./I18n-B80ZCpjQ.js";
import { _ as __nuxt_component_0 } from "./nuxt-link-BShvH9Ev.js";
import { PerfectScrollbar } from "vue3-perfect-scrollbar";
import { V as VNodeRenderer } from "./VNodeRenderer-Bra48hm7.js";
...
import "@antfu/utils";
import "./formatters-BiUWZhXP.js";
import "./VBadge-DOfNVkQM.js";
...
import "./VCard-u8p0g_5j.js";
import "./VCardText-Dvf5gJn3.js";
import "./VChip-DklVb85L.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderSlot(_ctx.$slots, "after-nav-items", {}, () => {
              if (props.bottomNavItems?.length) {
            ...
            return [
              ...
              renderSlot(_ctx.$slots, "after-nav-items", {}, () => [
                props.bottomNavItems?.length ? (openBlock(), createBlock("div", {
                  key: 0,
      ...
      _push(ssrRenderComponent(unref(_sfc_main$3), mergeProps({
        ...
        navbar: withCtx(({ toggleVerticalOverlayNavActive }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(themeConfig).app.i18n.enable && unref(themeConfig).app.i18n.langConfig?.length) {
            ...
            return [
              createVNode("div", { class: "d-flex h-100 align-center" }, [
                ...
                createVNode(VSpacer),
                unref(themeConfig).app.i18n.enable && unref(themeConfig).app.i18n.langConfig?.length ? (openBlock(), createBlock(_sfc_main$7, {
                  key: 0,
                  languages: unref(themeConfig).app.i18n.langConfig
