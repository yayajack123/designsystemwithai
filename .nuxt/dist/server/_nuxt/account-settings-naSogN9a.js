import { _ as _sfc_main$7 } from "./UiSectionHeader-DuDEa5TY.js";
import { defineComponent, ref, withCtx, createVNode, toDisplayString, createTextVNode, isRef, unref, useSSRContext, withAsyncContext, openBlock, createBlock, createCommentVNode, withModifiers, Fragment, renderList } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrRenderTeleport, ssrRenderAttrs, ssrRenderList } from "vue/server-renderer";
import { V as VDialog } from "./VDialog-Bx9nn4_A.js";
import { V as VCard, c as VCardItem, a as VCardTitle } from "./VCard-u8p0g_5j.js";
import { V as VCardText } from "./VCardText-Dvf5gJn3.js";
import { V as VBtn, a as VIcon, u as useNuxtApp, aW as useAuthStore, aY as _export_sfc } from "../server.mjs";
import { u as useValidation, a as accountValidations, _ as _sfc_main$6, p as profileValidations, b as changePasswordValidations } from "./account-settings-j7EjwIPP.js";
...
import "@antfu/utils";
import "./VAutocomplete-BOSWNh7y.js";
...
const AVATAR_1 = "" + __buildAssetsURL("avatar-1.CxOKCzdw.png");
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(VBtn, {
                    ...
                    color: "primary",
                    variant: "outlined",
                    onClick: ($event) => unref(refInputEl)?.click()
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const isConfirmDialogOpen = ref(false);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UiAutoComplete = _sfc_main$6;
      const _component_ConfirmDialog = _sfc_main$5;
      _push(`<!--[--><form>`);
      _push(ssrRenderComponent(VCard, { class: "mb-5" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UiSectionHeader = _sfc_main$7;
