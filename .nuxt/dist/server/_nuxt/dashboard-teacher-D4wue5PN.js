...
import { computed, ref, shallowRef, watchEffect, watch, createVNode, mergeProps, Fragment, withDirectives, resolveDirective, vModelText, nextTick, defineComponent, resolveComponent, unref, withCtx, toDisplayString, isRef, createTextVNode, openBlock, createBlock, renderList, createCommentVNode, useSSRContext } from "vue";
...
import { q as genericComponent, C as useProxiedModel, G as useRender, ak as filterInputAttrs, m as convertToUnit, al as callEvent, I as propsFactory, an as clamp, a as VIcon, V as VBtn, aY as _export_sfc } from "../server.mjs";
      ...
      _push(ssrRenderComponent(UiTableView, {
        ...
        "card-header": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><p class="text-body-2 text-medium-emphasis mb-0" data-v-c75ae2c2${_scopeId}> Latest fixed-block evaluation · refreshed every Monday </p></div>`);
        ...
        "item.student": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="min-w-0" data-v-c75ae2c2${_scopeId}><span class="student-name font-weight-medium" data-v-c75ae2c2${_scopeId}>${ssrInterpolate(item.name)}</span><span class="student-course text-caption" data-v-c75ae2c2${_scopeId}>${ssrInterpolate(item.course)} · ${ssrInterpolate(item.window)}</span></div></div>`);
          } else {
            return [
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCardTitle, { class: "d-flex align-start justify-space-between gap-4 pa-6 pb-2" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div data-v-c75ae2c2${_scopeId3}><span class="text-h5 text-high-emphasis" data-v-c75ae2c2${_scopeId3}>Follow up with ${ssrInterpolate(unref(activeWatchlistItem)?.name)}</span></div>`);
                  ...
                  _push3(ssrRenderComponent(VCardText, { class: "px-6 pt-3" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<span class="text-body-2 text-medium-emphasis" data-v-c75ae2c2${_scopeId3}>${ssrInterpolate(unref(activeWatchlistItem)?.issue)}</span></div>`);
