import { defineComponent, ref, computed, watch, mergeProps, withCtx, createVNode, toDisplayString, createTextVNode, openBlock, createBlock, createCommentVNode, Fragment, useSSRContext } from "vue";
...
import { U as UiTableView } from "./UiTableView-B3siXicH.js";
import { P as PresenceDialog } from "./PresenceDialog-CyKIPrrH.js";
import "/Users/user/Documents/Code Project/microdemy-DS/node_modules/hookable/dist/index.mjs";
import { a as VIcon, V as VBtn, n as navigateTo, aY as _export_sfc } from "../server.mjs";
...
import { k as VDataTable } from "./VDataTable-C1JSmJGp.js";
import { V as VTextField } from "./VTextField-Cd5QA0t5.js";
...
import "./DialogCloseBtn-CVR_yFk0.js";
import "./VDialog-Bx9nn4_A.js";
import "./dialog-transition-BWrfOTuu.js";
import "./VCheckbox-CzrpsCpF.js";
import "./VCheckboxBtn-HaMxb5RF.js";
import "./VSelectionControl-CYxe30_l.js";
...
import "@antfu/utils";
/* empty css               */
import "./VDataTableFooter-fQK99chc.js";
import "./filter-CITo5F-X.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCard, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="flex-grow-1" data-v-175736f1${_scopeId3}><span class="text-body-1 text-medium-emphasis mb-1 d-block" data-v-175736f1${_scopeId3}>Class name</span><span class="text-h4 font-weight-medium text-high-emphasis" data-v-175736f1${_scopeId3}>${ssrInterpolate(classSession.value?.name)}</span></div>`);
                        ...
                        return [
                          createVNode("div", { class: "flex-grow-1" }, [
                            ...
                            createVNode("span", { class: "text-h4 font-weight-medium text-high-emphasis" }, toDisplayString(classSession.value?.name), 1)
                          ]),
                          createVNode(VAvatar, {
                            size: "42",
                            color: "rgba(var(--v-theme-primary), 0.08)",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VCard, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="flex-grow-1" data-v-175736f1${_scopeId3}><span class="text-body-1 text-medium-emphasis mb-1 d-block" data-v-175736f1${_scopeId3}>Room Name</span><span class="text-h4 font-weight-medium text-high-emphasis" data-v-175736f1${_scopeId3}>${ssrInterpolate(classSession.value?.room)}</span></div>`);
                        _push4(ssrRenderComponent(VAvatar, {
                          size: "42",
                          color: "rgba(var(--v-theme-primary), 0.08)",
                          class: "rounded-lg text-primary"
                        ...
                        return [
                          createVNode("div", { class: "flex-grow-1" }, [
                            ...
                            createVNode("span", { class: "text-h4 font-weight-medium text-high-emphasis" }, toDisplayString(classSession.value?.room), 1)
                          ]),
                          createVNode(VAvatar, {
                            size: "42",
                            color: "rgba(var(--v-theme-primary), 0.08)",
      ...
      _push(ssrRenderComponent(VChip, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(classSession.value?.teachers.length || 0)} Teachers `);
          } else {
            return [
              createTextVNode(toDisplayString(classSession.value?.teachers.length || 0) + " Teachers ", 1)
            ];
          }
        }),
        _: 1
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VDataTable, {
              ...
              items: classSession.value?.teachers || [],
              class: "text-no-wrap",
              "hide-default-footer": ""
            }, {
