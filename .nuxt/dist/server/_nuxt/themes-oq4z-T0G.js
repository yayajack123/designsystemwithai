import { defineComponent, mergeProps, withCtx, createTextVNode, toDisplayString, createVNode, useSSRContext, ref, computed, openBlock, createBlock, Fragment, renderList } from "vue";
...
const farmerImage = "" + __buildAssetsURL("theme-farmer.DnU4cMpZ.png");
const spaceImage = "" + __buildAssetsURL("theme-space.CQosHA4f.png");
const deepSeaImage = "" + __buildAssetsURL("theme-deep-sea.BUOJyPZb.png");
const springImage = "" + __buildAssetsURL("theme-autumn.DkoSTqPH.png");
const summerImage = "" + __buildAssetsURL("theme-farmer.DnU4cMpZ.png");
const autumnImage = "" + __buildAssetsURL("theme-autumn.DkoSTqPH.png");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VSnackbar, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(selectedTheme.value?.name)} selected `);
          } else {
            return [
              createTextVNode(toDisplayString(selectedTheme.value?.name) + " selected ", 1)
            ];
          }
        }),
        _: 1
