...
import { ref, computed, createVNode, mergeProps, Fragment, defineComponent, watch, withCtx, toDisplayString, createTextVNode, openBlock, createBlock, createCommentVNode, withDirectives, vShow, renderList, useSSRContext } from "vue";
...
import { V as VCard, c as VCardItem, b as VCardActions } from "./VCard-u8p0g_5j.js";
import { q as genericComponent, C as useProxiedModel, Y as useLoader, af as getUid, G as useRender, ak as filterInputAttrs, H as VDefaultsProvider, a as VIcon, a0 as LoaderSlot, b as VProgressCircular, b8 as IN_BROWSER, I as propsFactory, V as VBtn, aY as _export_sfc } from "../server.mjs";
...
import { V as VCheckbox } from "./VCheckbox-Cpfyb-Ax.js";
import { d as VScaleTransition } from "./index-CGI_inNZ.js";
import { i as useFocus, d as VInput, e as makeVInputProps, V as VTextField } from "./VTextField-CQSxiXKB.js";
import { V as VSelectionControl, m as makeVSelectionControlProps } from "./VSelectionControl-DaNxjNnI.js";
            ...
            _push2(ssrRenderComponent(VCard, { class: "overflow-hidden presence-dialog-card" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span class="text-subtitle-1 font-weight-medium text-high-emphasis" data-v-8b61e005${_scopeId2}>${ssrInterpolate(_ctx.classSession?.name || "Class Session")}</span>`);
                  if (_ctx.classSession?.date) {
                  ...
                  _push3(`<span class="text-body-2 text-medium-emphasis" data-v-8b61e005${_scopeId2}>${ssrInterpolate(_ctx.classSession?.timeStart)} - ${ssrInterpolate(_ctx.classSession?.timeEnd)}</span></div>`);
                  ...
                  return [
                    ...
                    createVNode("div", { class: "px-8 py-3 bg-light-green border-b border-light d-flex align-center gap-4 flex-wrap" }, [
                      ...
                      createVNode("span", { class: "text-subtitle-1 font-weight-medium text-high-emphasis" }, toDisplayString(_ctx.classSession?.name || "Class Session"), 1),
                      _ctx.classSession?.date ? (openBlock(), createBlock(VChip, {
                        key: 0,
                        size: "small",
                        color: "primary",
                        variant: "tonal",
                      ...
                      createVNode("span", { class: "text-body-2 text-medium-emphasis" }, toDisplayString(_ctx.classSession?.timeStart) + " - " + toDisplayString(_ctx.classSession?.timeEnd), 1)
                    ]),
                    createVNode(VCardText, {
                      class: "pa-8 bg-grey-light overflow-y-auto",
                      style: { "max-height": "calc(90vh - 280px)" }
