import { defineComponent, ref, computed, withCtx, createVNode, mergeProps, toDisplayString, createTextVNode, openBlock, createBlock, createCommentVNode, useSSRContext } from "vue";
...
import { V as VBtn, aY as _export_sfc } from "../server.mjs";
...
import { V as VList, a as VListItem, b as VListItemTitle, d as VListItemSubtitle } from "./VList-MvyrR4cM.js";
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      ...
                                      _push6(ssrRenderComponent(VListItemSubtitle, { class: "text-body-1 text-high-emphasis" }, {
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`${ssrInterpolate(tabs.find((t) => t.value === _ctx.selectedStudent?.tab)?.label)}`);
                                          } else {
                                            return [
                                              createTextVNode(toDisplayString(tabs.find((t) => t.value === _ctx.selectedStudent?.tab)?.label), 1)
                                            ];
                                          }
                                        }),
                                        _: 1
