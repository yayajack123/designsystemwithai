...
import { b5 as useConfigStore, c as useRouter, a as VIcon, bv as withQuery } from "../server.mjs";
import { e as VListSubheader, a as VListItem, b as VListItemTitle, V as VList } from "./VList-MvyrR4cM.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const LazyAppBarSearch = defineAsyncComponent(() => import("./AppBarSearch-CXRH8Gpx.js"));
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_IconBtn, {
        onClick: ($event) => unref(Shepherd).activeTour?.cancel()
      }, {
