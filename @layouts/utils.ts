 ...
 */
export const isNavLinkActive = (link: NavLink, _: Router) => {
  // Matched routes array of current route

  const route = useRoute()

  if (!route.meta.sidebarRoute)
    return false

  return route.meta.sidebarRoute === (link.to as RouteLocationAsRelativeTyped)?.name
}
