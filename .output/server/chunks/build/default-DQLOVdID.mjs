...
import { b5 as useConfigStore, bv as switchToVerticalNavOnLtOverlayNavBreakpoint, bb as AppContentLayoutNav } from './server.mjs';
import { u as useSkins } from './useSkins-dhKxh8fy.mjs';
import 'node:http';
import 'node:https';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const DefaultLayoutWithHorizontalNav = defineAsyncComponent(() => import('./DefaultLayoutWithHorizontalNav-DMdF8XAz.mjs'));
    const DefaultLayoutWithVerticalNav = defineAsyncComponent(() => import('./DefaultLayoutWithVerticalNav-C61k4Aa5.mjs'));
