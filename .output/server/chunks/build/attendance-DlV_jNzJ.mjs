import { defineComponent, nextTick, h, ref, computed, provide, watch, mergeProps, withCtx, isRef, unref, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, createCommentVNode, withModifiers, useAttrs, useSSRContext } from 'vue';
...
import { V as VTextField, a as VInput, f as filterFieldProps, e as VField, g as makeVFieldProps, d as makeVInputProps } from './VTextField-CQSxiXKB.mjs';
import { aY as _export_sfc, c as useRouter$1, V as VBtn, a as VIcon, b5 as useConfigStore, ak as filterInputAttrs, b6 as useFocus, b7 as useTheme } from './server.mjs';
import { P as PresenceDialog } from './PresenceDialog-CRqfr6aw.mjs';
import { _ as _sfc_main$3 } from './DialogCloseBtn-CVR_yFk0.mjs';
import { V as VDialog } from './VDialog-Bx9nn4_A.mjs';
import { V as VCard, a as VCardTitle, b as VCardActions, c as VCardItem } from './VCard-u8p0g_5j.mjs';
...
import { V as VAutocomplete } from './VAutocomplete-Cg01jdip.mjs';
...
import { V as VDataTableFooter } from './VDataTableFooter-BLyT_THf.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isTeachersExpanded = (classId) => {
      var _a, _b;
      return (_b = (_a = expandedCards.value[classId]) == null ? void 0 : _a.teachers) != null ? _b : false;
    };
    const isStudentsExpanded = (classId) => {
      var _a, _b;
      return (_b = (_a = expandedCards.value[classId]) == null ? void 0 : _a.students) != null ? _b : false;
    };
