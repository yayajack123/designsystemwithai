import { computed, watchEffect, provide, createVNode, mergeProps, inject, shallowRef, toRef, watch, ref, nextTick } from 'vue';
import { C as useProxiedModel, q as genericComponent, aa as useLocale, G as useRender, an as clamp, s as useRtl, t as provideTheme, z as useDisplay, F as provideDefaults, am as useResizeObserver, aM as createRange, V as VBtn, I as propsFactory, R as IconValue, ag as getCurrentInstance, aN as keyValues, a2 as makeVariantProps, J as makeThemeProps, K as makeTagProps, aB as makeSizeProps, L as makeRoundedProps, N as makeElevationProps, S as makeDensityProps, P as makeComponentProps, Q as makeBorderProps } from './server.mjs';
...
export { VDataTableFooter as V, makeDataTablePaginateProps as a, createPagination as c, makeVDataTableFooterProps as m, providePagination as p, usePaginatedItems as u };
