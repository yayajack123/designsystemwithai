import { _ as __nuxt_component_0 } from './nuxt-link-BShvH9Ev.mjs';
import { defineComponent, ref, computed, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, unref, createTextVNode, withDirectives, createCommentVNode, vShow, isRef, useSSRContext } from 'vue';
...
import { V as VExpandTransition } from './index-CGI_inNZ.mjs';
import { V as VRow, a as VCol } from './VRow-BKXTxdYZ.mjs';
import { V as VCard } from './VCard-u8p0g_5j.mjs';
import { aY as _export_sfc, a as VIcon, V as VBtn, b3 as VProgressLinear } from './server.mjs';
import { V as VAvatar } from './VAvatar-Bov4ZLUZ.mjs';
import { V as VChip } from './VChip-DklVb85L.mjs';
import { V as VCheckbox } from './VCheckbox-CzrpsCpF.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const selectedClassId = ref((_d = (_c = (_a = upcomingClasses.value.find((c) => c.status === "Ongoing")) == null ? void 0 : _a.id) != null ? _c : (_b = upcomingClasses.value[0]) == null ? void 0 : _b.id) != null ? _d : "");
    ...
    const getSupportColor = (status) => {
      var _a2, _b2;
      return (_b2 = (_a2 = supportStatusMap[status]) == null ? void 0 : _a2.color) != null ? _b2 : "grey";
    };
    const getSupportLabel = (status) => {
      var _a2, _b2;
      return (_b2 = (_a2 = supportStatusMap[status]) == null ? void 0 : _a2.label) != null ? _b2 : status;
    };
    const getPaceLabel = (pace) => {
      var _a2, _b2;
      return (_b2 = (_a2 = paceMap[pace]) == null ? void 0 : _a2.label) != null ? _b2 : pace;
    };
    const getRatingLabel = (rating) => {
      var _a2, _b2;
      return (_b2 = (_a2 = ratingMap[rating]) == null ? void 0 : _a2.label) != null ? _b2 : rating;
    };
                              ...
                              return openBlock(), createBlock("div", {
                                ...
                                createVNode("div", { class: "d-flex flex-column flex-grow-1 min-w-0" }, [
                                  ...
                                  createVNode("span", {
                                    ...
                                    createVNode("span", { class: "mx-1" }, "\xB7"),
                              ...
                              createVNode("div", { class: "d-flex align-start justify-space-between mb-2" }, [
                                ...
                                createVNode("div", { class: "text-right flex-shrink-0" }, [
                                  ...
                                  createVNode("span", {
                                    ...
                                    style: { color: `rgb(var(--v-theme-${(_d2 = (_c2 = paceMap[student.pace]) == null ? void 0 : _c2.color) != null ? _d2 : "warning"}))` }
                            ...
                            createVNode("div", {
                              ...
                              createVNode("div", { class: "d-flex align-start justify-space-between mb-2" }, [
                                ...
                                createVNode("div", { class: "text-right flex-shrink-0" }, [
                                  ...
                                  createVNode("span", {
                                    class: "text-caption font-weight-medium",
                                    style: { color: `rgb(var(--v-theme-${(_b2 = (_a2 = paceMap[student.pace]) == null ? void 0 : _a2.color) != null ? _b2 : "warning"}))` }
                                  }, toDisplayString(getPaceLabel(student.pace)), 5)
                                ])
                              ]),
                              createVNode("div", { class: "d-flex align-center justify-space-between gap-2" }, [
