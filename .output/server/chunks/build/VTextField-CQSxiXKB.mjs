import { computed, ref, createVNode, mergeProps, Fragment, withDirectives, resolveDirective, cloneVNode, vShow, toRef, watch, nextTick, shallowRef, unref, inject, provide, markRaw } from 'vue';
import { b as VExpandXTransition, c as VSlideYTransition } from './index-CGI_inNZ.mjs';
import { q as genericComponent, C as useProxiedModel, G as useRender, ak as filterInputAttrs, ad as getCurrentInstanceName, W as useDensity, X as useDimension, t as provideTheme, s as useRtl, af as getUid, ai as isOn, aj as pick, Y as useLoader, A as useRounded, x as useBackgroundColor, ac as useTextColor, a0 as LoaderSlot, H as VDefaultsProvider, al as callEvent, I as propsFactory, aa as useLocale, ab as wrapInArray, ag as getCurrentInstance, o as useToggleScope, R as IconValue, J as makeThemeProps, ah as only, a7 as makeDimensionProps, S as makeDensityProps, P as makeComponentProps, a9 as EventProp, m as convertToUnit, L as makeRoundedProps, a6 as makeLoaderProps, a as VIcon, ae as consoleWarn } from './server.mjs';
import { I as Intersect, M as MaybeTransition, m as makeTransitionProps } from './VAvatar-Bov4ZLUZ.mjs';
import { f as forwardRefs, n as nullifyTransforms, a as animate, s as standardEasing } from './forwardRefs-CtuH3aYe.mjs';
...
export { VTextField as V, VInput as a, VLabel as b, createForm as c, makeVInputProps as d, VField as e, filterFieldProps as f, makeVFieldProps as g, makeVTextFieldProps as h, useFocus as i, VCounter as j, makeFormProps as m, useForm as u };
