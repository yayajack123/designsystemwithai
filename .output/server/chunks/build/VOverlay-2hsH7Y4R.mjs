import { computed, toRef, watch, ref, createVNode, Fragment, mergeProps, Teleport, withDirectives, vShow, resolveDirective, shallowRef, inject, reactive, provide, onScopeDispose, toRaw, watchEffect, readonly, nextTick, Transition } from 'vue';
import { a as animate, g as getTargetBox, B as Box, b as getOverflow, n as nullifyTransforms, s as standardEasing } from './forwardRefs-CtuH3aYe.mjs';
import { ag as getCurrentInstance, q as genericComponent, C as useProxiedModel, t as provideTheme, s as useRtl, x as useBackgroundColor, X as useDimension, B as useRouter, o as useToggleScope, G as useRender, m as convertToUnit, aV as templateRef, I as propsFactory, J as makeThemeProps, a7 as makeDimensionProps, P as makeComponentProps, aq as matchesSelector, aO as destructComputed, aP as parseAnchor, aQ as flipSide, aR as flipAlign, aS as flipCorner, aJ as consoleError, aT as getAxis, an as clamp, aU as defer } from './server.mjs';
import { M as MaybeTransition, m as makeTransitionProps } from './VAvatar-Bov4ZLUZ.mjs';
