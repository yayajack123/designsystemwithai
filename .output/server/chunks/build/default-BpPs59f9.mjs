...
import { u as useSkins } from './useSkins-BDAIJZHC.mjs';
import 'node:http';
import 'node:https';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const DefaultLayoutWithHorizontalNav = defineAsyncComponent(() => import('./DefaultLayoutWithHorizontalNav-Bsibo2Di.mjs'));
    const DefaultLayoutWithVerticalNav = defineAsyncComponent(() => import('./DefaultLayoutWithVerticalNav-C7p9J0zF.mjs'));
