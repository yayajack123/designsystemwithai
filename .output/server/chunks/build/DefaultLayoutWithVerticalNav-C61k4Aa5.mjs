import { defineComponent, resolveComponent, unref, mergeProps, withCtx, renderSlot, createVNode, openBlock, createBlock, createCommentVNode, ref, watch, computed, toRef, resolveDynamicComponent, provide, Fragment, renderList, withDirectives, vShow, createTextVNode, toDisplayString, inject, TransitionGroup, h, Transition, useSSRContext } from 'vue';
...
import { a as VIcon, aX as themeConfig, br as useWindowSize, bd as useLayoutConfigStore, bs as useToggle, bt as syncRef, aY as _export_sfc, u as useNuxtApp, ba as storeToRefs, aW as useAuthStore, bo as useElementHover, bp as injectionKeyIsVerticalNavHovered, bc as useRoute$1, bf as layoutConfig, bg as getDynamicI18nProps, c as useRouter$1, be as isNavGroupActive, bq as openGroups, bh as getComputedNavLinkToProp, bi as isNavLinkActive } from './server.mjs';
import _sfc_main$9 from './NavBarNotifications-CBiSFxoh.mjs';
import _sfc_main$8 from './NavbarThemeSwitcher-C6RXK2Po.mjs';
import _sfc_main$a from './UserProfile-MTJs3d-E.mjs';
import { _ as _sfc_main$7, a as can, c as canViewNavMenuGroup } from './I18n-B80ZCpjQ.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-BShvH9Ev.mjs';
import { PerfectScrollbar } from 'vue3-perfect-scrollbar';
import { V as VNodeRenderer } from './VNodeRenderer-Bra48hm7.mjs';
