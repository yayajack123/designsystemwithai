import { defineComponent, ref, watch, resolveComponent, mergeProps, withCtx, isRef, unref, createVNode, withKeys, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, renderSlot, withDirectives, vShow, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderList, ssrRenderSlot, ssrInterpolate, ssrRenderStyle } from 'vue/server-renderer';
import { PerfectScrollbar } from 'vue3-perfect-scrollbar';
import { aY as _export_sfc, bx as useMagicKeys, a as VIcon } from './server.mjs';
...
export { AppBarSearch as default };
