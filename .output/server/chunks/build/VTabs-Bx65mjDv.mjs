...
const VTab = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const isSelected = computed(() => {
      var _a, _b, _c;
      return (_c = (_b = (_a = rootEl.value) == null ? void 0 : _a.group) == null ? void 0 : _b.isSelected.value) != null ? _c : false;
    });
    ...
    useRender(() => {
      ...
      return createVNode(VBtn, mergeProps({
        ...
        default: () => {
          var _a, _b;
          return createVNode(Fragment, null, [(_b = (_a = slots.default) == null ? void 0 : _a.call(slots)) != null ? _b : props.text, !props.hideSlider && createVNode("div", {
            "ref": sliderEl,
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return createVNode(Fragment, null, [createVNode(VSlideGroup, mergeProps(slideGroupProps, {
        ...
        default: () => {
          var _a, _b;
          return [(_b = (_a = slots.default) == null ? void 0 : _a.call(slots)) != null ? _b : items.value.map((item) => {
            var _a2, _b2;
            return (_b2 = (_a2 = slots.tab) == null ? void 0 : _a2.call(slots, {
              item
        ...
        default: () => {
          ...
          return [items.value.map((item) => {
            var _a2, _b;
            return (_b = (_a2 = slots.item) == null ? void 0 : _a2.call(slots, {
              item
...
export { VTabs as V, VTab as a, VSkeletonLoader as b };
