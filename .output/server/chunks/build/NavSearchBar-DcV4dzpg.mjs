...
import { b5 as useConfigStore, c as useRouter$1, a as VIcon, bu as withQuery } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const LazyAppBarSearch = defineAsyncComponent(() => import('./AppBarSearch-C4PKF1EP.mjs'));
