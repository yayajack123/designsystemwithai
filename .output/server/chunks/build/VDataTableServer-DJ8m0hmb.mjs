import { ref, computed, toRefs, toRef, provide, createVNode, mergeProps, Fragment, defineComponent, withCtx, unref, createTextVNode, withModifiers, shallowRef, watch, nextTick, Transition, resolveComponent, watchEffect, onScopeDispose, useSSRContext } from 'vue';
import { l as watchDebounced, q as genericComponent, F as provideDefaults, G as useRender, u as useNuxtApp, V as VBtn, s as useRtl, t as provideTheme, v as useBorder, x as useBackgroundColor, y as useElevation, z as useDisplay, A as useRounded, B as useRouter, C as useProxiedModel, D as toPhysical, o as useToggleScope, E as useLayoutItem, H as VDefaultsProvider, a as VIcon, I as propsFactory, m as convertToUnit, J as makeThemeProps, K as makeTagProps, L as makeRoundedProps, M as makeLayoutItemProps, N as makeElevationProps, O as makeDisplayProps, P as makeComponentProps, Q as makeBorderProps } from './server.mjs';
...
import { u as useValidation, _ as _sfc_main$2, c as createAccountValidations } from './account-settings-DmqwVHDB.mjs';
import { PerfectScrollbar } from 'vue3-perfect-scrollbar';
import { u as useScopeId, a as useDelay, m as makeDelayProps } from './VOverlay-2hsH7Y4R.mjs';
...
import { V as VTextField } from './VTextField-CQSxiXKB.mjs';
import { c as createGroupBy, b as createSort, d as createHeaders, u as useDataTableItems, p as provideSort, e as provideGroupBy, f as useGroupedItems, g as provideSelection, h as provideExpanded, i as useOptions, j as VDataTableHeaders, k as VDataTableRows, a as VTable, m as makeDataTableProps } from './VDataTable-C0L9o-6N.mjs';
import { c as createPagination, p as providePagination, V as VDataTableFooter, m as makeVDataTableFooterProps, a as makeDataTablePaginateProps } from './VDataTableFooter-BLyT_THf.mjs';
...
export { VDataTableServer as V, _sfc_main as _, VNavigationDrawer as a, _sfc_main$1 as b, useDatatable as u };
