      ...
      _push(ssrRenderComponent(UiTableView, {
        ...
        "card-header": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><p class="text-body-2 text-medium-emphasis mb-0" data-v-6b412c5c${_scopeId}> Latest fixed-block evaluation \xB7 refreshed every Monday </p></div>`);
        ...
        "item.student": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="min-w-0" data-v-6b412c5c${_scopeId}><span class="student-name font-weight-medium" data-v-6b412c5c${_scopeId}>${ssrInterpolate(item.name)}</span><span class="student-course text-caption" data-v-6b412c5c${_scopeId}>${ssrInterpolate(item.course)} \xB7 ${ssrInterpolate(item.window)}</span></div></div>`);
          } else {
            return [
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCardTitle, { class: "d-flex align-start justify-space-between gap-4 pa-6 pb-2" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      var _a, _b;
                      if (_push4) {
                        _push4(`<div data-v-6b412c5c${_scopeId3}><span class="text-h5 text-high-emphasis" data-v-6b412c5c${_scopeId3}>Follow up with ${ssrInterpolate((_a = unref(activeWatchlistItem)) == null ? void 0 : _a.name)}</span></div>`);
                  ...
                  _push3(ssrRenderComponent(VCardText, { class: "px-6 pt-3" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        ...
                        _push4(`<span class="text-body-2 text-medium-emphasis" data-v-6b412c5c${_scopeId3}>${ssrInterpolate((_a = unref(activeWatchlistItem)) == null ? void 0 : _a.issue)}</span></div>`);
