import { defineComponent, useModel, mergeProps, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, createTextVNode, toDisplayString, Fragment, renderList, createVNode, createSlots, mergeModels, useSSRContext } from 'vue';
...
import { V as VTabs, a as VTab, b as VSkeletonLoader } from './VTabs-Bx65mjDv.mjs';
import { aY as _export_sfc, a as VIcon, V as VBtn, aZ as VBtnToggle } from './server.mjs';
...
import { V as VDataTable } from './VDataTable-C0L9o-6N.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: /* @__PURE__ */ mergeModels({
    ...
    tabsInsideCard: { type: Boolean, default: false },
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "ui-table-view" }, _attrs))} data-v-5da4b056>`);
      if (props.title) {
      ...
      if (!props.tabsInsideCard && props.tabs && props.tabs.length) {
                ...
                _push2(ssrRenderComponent(VTab, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      if (tab.count !== void 0) {
                        _push3(`<span class="${ssrRenderClass([tab.badgeColor ? `bg-${tab.badgeColor} text-white` : activeTab.value === tab.value ? "bg-primary text-white" : "bg-secondary text-white", "count-badge ms-2"])}" data-v-5da4b056${_scopeId2}>${ssrInterpolate(tab.count)}</span>`);
                      } else {
                        _push3(`<!---->`);
                      }
                    } else {
      ...
      _push(ssrRenderComponent(VCard, {
        ...
        elevation: props.flat ? 0 : void 0
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (props.tabsInsideCard && props.tabs && props.tabs.length) {
              ssrRenderSlot(_ctx.$slots, "card-header", {}, null, _push2, _parent2, _scopeId);
            } else {
              _push2(`<!---->`);
            }
            if (props.tabsInsideCard && props.tabs && props.tabs.length) {
                      ...
                      _push3(ssrRenderComponent(VTab, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            ...
                            if (tab.count !== void 0) {
                              _push4(`<span class="${ssrRenderClass([tab.badgeColor ? `bg-${tab.badgeColor} text-white` : activeTab.value === tab.value ? "bg-primary text-white" : "bg-secondary text-white", "count-badge ms-2"])}" data-v-5da4b056${_scopeId3}>${ssrInterpolate(tab.count)}</span>`);
                            } else {
                              _push4(`<!---->`);
                            }
                          } else {
            ...
            if (!props.hideFilters) {
              _push2(ssrRenderComponent(VCardText, { class: "d-flex align-center justify-space-between flex-wrap gap-4 py-4" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="d-flex align-center flex-wrap gap-4 flex-grow-1" data-v-5da4b056${_scopeId2}>`);
                    ...
                    if (props.showViewToggle) {
                      _push3(`<div class="d-flex align-center gap-2" data-v-5da4b056${_scopeId2}>`);
            ...
            if (props.loading) {
              _push2(`<div class="pa-6" data-v-5da4b056${_scopeId}><!--[-->`);
              ssrRenderList(3, (n) => {
              ...
              if (viewType.value === "list") {
                _push2(`<div data-v-5da4b056${_scopeId}>`);
            ...
            return [
              props.tabsInsideCard && props.tabs && props.tabs.length ? renderSlot(_ctx.$slots, "card-header", { key: 0 }, void 0, true) : createCommentVNode("", true),
              props.tabsInsideCard && props.tabs && props.tabs.length ? (openBlock(), createBlock(VTabs, {
                key: 1,
                modelValue: activeTab.value,
                "onUpdate:modelValue": ($event) => activeTab.value = $event,
                class: "v-tabs-bordered"
              ...
              props.tabsInsideCard && props.tabs && props.tabs.length ? (openBlock(), createBlock(VDivider, { key: 2 })) : createCommentVNode("", true),
              !props.hideFilters ? (openBlock(), createBlock(VCardText, {
                key: 3,
              ...
              !props.hideFilters ? (openBlock(), createBlock(VDivider, { key: 4 })) : createCommentVNode("", true),
              props.loading ? (openBlock(), createBlock("div", {
                ...
                viewType.value === "list" ? (openBlock(), createBlock("div", { key: 0 }, [
                  renderSlot(_ctx.$slots, "table-content", {}, () => [
                    ...
                    ]), 1032, ["headers", "items", "items-per-page", "hide-default-footer", "class"])
                  ], true)
...
const UiTableView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5da4b056"]]);
