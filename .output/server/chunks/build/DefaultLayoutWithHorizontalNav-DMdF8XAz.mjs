...
import { defineComponent, unref, mergeProps, withCtx, renderSlot, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, resolveDynamicComponent, ref, watch, createTextVNode, Fragment, renderList, withDirectives, vShow, useSSRContext } from 'vue';
...
import { aX as themeConfig, bd as useLayoutConfigStore, bc as useRoute$1, c as useRouter$1, be as isNavGroupActive, bf as layoutConfig, bg as getDynamicI18nProps, bh as getComputedNavLinkToProp, bi as isNavLinkActive, bj as until, bk as useEventListener } from './server.mjs';
import _sfc_main$7 from './NavbarThemeSwitcher-C6RXK2Po.mjs';
import _sfc_main$8 from './UserProfile-MTJs3d-E.mjs';
import { _ as _sfc_main$6, c as canViewNavMenuGroup, a as can } from './I18n-B80ZCpjQ.mjs';
