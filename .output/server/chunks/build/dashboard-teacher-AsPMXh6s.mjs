...
import { aY as _export_sfc, b9 as __nuxt_component_0$1, a as VIcon, V as VBtn, q as genericComponent, C as useProxiedModel, G as useRender, ak as filterInputAttrs, m as convertToUnit, al as callEvent, I as propsFactory, an as clamp } from './server.mjs';
import { _ as _sfc_main$1 } from './DialogCloseBtn-CVR_yFk0.mjs';
import { defineComponent, ref, computed, resolveComponent, mergeProps, withCtx, unref, createVNode, toDisplayString, isRef, createTextVNode, openBlock, createBlock, Fragment, renderList, createCommentVNode, shallowRef, watchEffect, watch, withDirectives, resolveDirective, vModelText, nextTick, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "teacher-dashboard" }, _attrs))} data-v-48fc2d5e><header class="dashboard-header dashboard-reveal dashboard-reveal--1" data-v-48fc2d5e><div class="dashboard-header__content" data-v-48fc2d5e><h1 class="text-h4 text-high-emphasis mb-2" data-v-48fc2d5e> Good morning, Julie. </h1><p class="text-body-1 text-medium-emphasis mb-0" data-v-48fc2d5e> Here\u2019s your teaching brief. Start with what needs your attention today. </p></div><div class="dashboard-header__art" aria-hidden="true" data-v-48fc2d5e>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {
        fallback: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", unref(teacherWelcomeIllustration))} alt="" class="dashboard-header__illustration" data-v-48fc2d5e${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
      ...
      _push(`</div></header><div class="dashboard-layout" data-v-48fc2d5e><main class="dashboard-main" data-v-48fc2d5e><section class="recognition-card dashboard-reveal dashboard-reveal--2" aria-label="Personal achievement" data-v-48fc2d5e><div class="recognition-banner" data-v-48fc2d5e><div class="recognition-rail" aria-hidden="true" data-v-48fc2d5e>`);
      if (!unref(prefersReducedMotion)) {
        _push(`<lord-icon${ssrRenderAttr("src", unref(activeAppreciation).lordIconSrc)} trigger="loop" loading="lazy" class="recognition-lord-icon current-color" aria-hidden="true" data-v-48fc2d5e></lord-icon>`);
      } else {
      ...
      _push(`</div><div class="recognition-content" data-v-48fc2d5e><div class="appreciation-copy" aria-live="polite" data-v-48fc2d5e><h2 class="text-h6 font-weight-medium text-high-emphasis mb-1" data-v-48fc2d5e>${ssrInterpolate(unref(activeAppreciation).title)}</h2><p class="text-body-2 text-medium-emphasis mb-1 appreciation-quote" data-v-48fc2d5e> \u201C${ssrInterpolate(unref(activeAppreciation).quote)}\u201D </p><div class="d-flex align-center gap-2 text-caption text-medium-emphasis" data-v-48fc2d5e>`);
      _push(ssrRenderComponent(VIcon, {
        icon: "ri-checkbox-circle-line",
        size: "15"
      }, null, _parent));
      _push(`<span data-v-48fc2d5e>${ssrInterpolate(unref(activeAppreciation).detail)}</span></div></div></div><div class="recognition-banner-nav d-flex align-center gap-2" data-v-48fc2d5e>`);
      ...
      _push(`</div></div><div class="recognition-progress" aria-label="Appreciation carousel position" data-v-48fc2d5e><!--[-->`);
      ssrRenderList(appreciationItems, (_, index) => {
        _push(`<span class="${ssrRenderClass([{ "recognition-progress__item--active": index === unref(currentAppreciation) }, "recognition-progress__item"])}" data-v-48fc2d5e></span>`);
      });
      _push(`<!--]--></div></section><section class="dashboard-section dashboard-reveal dashboard-reveal--3" aria-labelledby="summary-heading" data-v-48fc2d5e><div class="section-heading" data-v-48fc2d5e><div data-v-48fc2d5e><h2 id="summary-heading" class="text-h5 text-high-emphasis mb-0" data-v-48fc2d5e> Your Statistic </h2></div><span class="section-meta text-caption" data-v-48fc2d5e>Updated today</span></div><div class="summary-grid" data-v-48fc2d5e><!--[-->`);
      ssrRenderList(summaryItems, (item) => {
        _push(ssrRenderComponent(VCard, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="summary-card__top" data-v-48fc2d5e${_scopeId}>`);
              _push2(ssrRenderComponent(VIcon, {
                icon: item.icon,
                size: "19"
              }, null, _parent2, _scopeId));
              _push2(`<span class="summary-card__period text-caption" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.period)}</span></div><span class="summary-card__value text-h3 font-weight-medium" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.value)}</span><span class="summary-card__label text-body-2 font-weight-medium" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.label)}</span>`);
            } else {
              return [
      ...
      _push(`<!--]--></div></section><section class="dashboard-section dashboard-reveal dashboard-reveal--4" aria-labelledby="watchlist-heading" data-v-48fc2d5e>`);
      _push(ssrRenderComponent(UiTableView, {
        ...
        "card-header": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card-heading" data-v-48fc2d5e${_scopeId}><div data-v-48fc2d5e${_scopeId}><div class="watchlist-title-row" data-v-48fc2d5e${_scopeId}><h2 id="watchlist-heading" class="text-h5 text-high-emphasis mb-0" data-v-48fc2d5e${_scopeId}> Priority Watchlist </h2>`);
            ...
            _push2(`</div><p class="text-body-2 text-medium-emphasis mb-0" data-v-48fc2d5e${_scopeId}> Latest fixed-block evaluation \xB7 refreshed every Monday </p></div>`);
        ...
        "item.student": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="student-cell" data-v-48fc2d5e${_scopeId}>`);
            _push2(ssrRenderComponent(VAvatar, {
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="text-caption font-weight-medium text-high-emphasis" data-v-48fc2d5e${_scopeId2}>${ssrInterpolate(getInitials(item.name))}</span>`);
                } else {
                  return [
            ...
            _push2(`<div class="min-w-0" data-v-48fc2d5e${_scopeId}><span class="student-name font-weight-medium" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.name)}</span><span class="student-course text-caption" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.course)} \xB7 ${ssrInterpolate(item.window)}</span></div></div>`);
          } else {
            return [
        ...
        "item.issue": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="issue-cell" data-v-48fc2d5e${_scopeId}><span class="issue-title font-weight-medium" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.issue)}</span><span class="issue-metric text-caption" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.metric)}</span></div>`);
          } else {
            return [
        ...
        "item.risk": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VChip, {
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="status-dot" data-v-48fc2d5e${_scopeId2}></span> ${ssrInterpolate(item.risk)}`);
                } else {
                  return [
        ...
        "no-data": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="empty-cell" data-v-48fc2d5e${_scopeId}> No students in this evaluation view. </div>`);
          } else {
            return [
      ...
      _push(`</section><section class="dashboard-section dashboard-reveal dashboard-reveal--5" aria-labelledby="pending-heading" data-v-48fc2d5e>`);
      _push(ssrRenderComponent(UiTableView, {
        ...
        "card-header": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card-heading" data-v-48fc2d5e${_scopeId}><div data-v-48fc2d5e${_scopeId}><h2 id="pending-heading" class="text-h5 text-high-emphasis mb-1" data-v-48fc2d5e${_scopeId}> Pending Task </h2><p class="text-body-2 text-medium-emphasis mb-0" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(unref(pendingTotal))} items are waiting across your workflows </p></div>`);
            _push2(ssrRenderComponent(VBtn, {
              variant: "text",
              color: "primary",
              size: "small",
        ...
        "item.student": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="student-name font-weight-medium" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.student)}</span>`);
          } else {
            return [
        ...
        "item.course": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="table-muted text-caption" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.course)}</span>`);
          } else {
            return [
        ...
        "item.lesson": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="table-muted text-caption" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.lesson)}</span>`);
          } else {
            return [
        ...
        "item.due": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="due-label text-body-2 font-weight-medium" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.due)}</span>`);
          } else {
            return [
        ...
        "no-data": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="empty-cell" data-v-48fc2d5e${_scopeId}> Nothing is waiting here. Keep the good rhythm going. </div>`);
          } else {
            return [
      ...
      _push(`</section></main><aside class="dashboard-aside dashboard-reveal dashboard-reveal--2" data-v-48fc2d5e>`);
      _push(ssrRenderComponent(VCard, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="schedule-card__header" data-v-48fc2d5e${_scopeId}><div data-v-48fc2d5e${_scopeId}><h2 class="text-h5 text-high-emphasis mb-1" data-v-48fc2d5e${_scopeId}>Upcoming schedule</h2><p class="text-body-2 text-medium-emphasis mb-0" data-v-48fc2d5e${_scopeId}>Three moments to prepare for</p></div>`);
            _push2(ssrRenderComponent(VIcon, {
              icon: "ri-calendar-schedule-line",
              color: "primary",
              size: "22"
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="schedule-list" data-v-48fc2d5e${_scopeId}><!--[-->`);
            ssrRenderList(scheduleItems, (item) => {
              _push2(`<div class="schedule-item" data-v-48fc2d5e${_scopeId}><div class="schedule-item__time" data-v-48fc2d5e${_scopeId}><span class="schedule-item__date text-caption" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.dateLabel)}</span><span class="schedule-item__clock text-body-2 font-weight-medium" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.timeLabel)}</span></div><div class="schedule-item__rule" data-v-48fc2d5e${_scopeId}></div><div class="schedule-item__content" data-v-48fc2d5e${_scopeId}><div class="d-flex align-start justify-space-between gap-2" data-v-48fc2d5e${_scopeId}><div class="min-w-0" data-v-48fc2d5e${_scopeId}><span class="schedule-item__name text-body-2 font-weight-medium" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.name)}</span><span class="schedule-item__meta text-caption" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.type)} \xB7 ${ssrInterpolate(item.students)} students</span></div><span class="${ssrRenderClass([`schedule-status--${item.status}`, "schedule-status"])}"${ssrRenderAttr("aria-label", `Schedule status: ${item.status}`)} data-v-48fc2d5e${_scopeId}><span class="status-dot" data-v-48fc2d5e${_scopeId}></span></span></div><span class="schedule-item__countdown text-caption font-weight-medium" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(getCountdown(item))}</span></div></div>`);
            });
            _push2(`<!--]--></div>`);
      ...
      _push(ssrRenderComponent(VCard, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="learning-card__header" data-v-48fc2d5e${_scopeId}><div class="learning-card__title-row" data-v-48fc2d5e${_scopeId}><span class="learning-card__icon" aria-hidden="true" data-v-48fc2d5e${_scopeId}>`);
            _push2(ssrRenderComponent(VIcon, {
              icon: "ri-book-open-line",
              color: "primary",
              size: "18"
            }, null, _parent2, _scopeId));
            _push2(`</span><h2 class="text-body-1 text-high-emphasis font-weight-medium mb-0" data-v-48fc2d5e${_scopeId}>Self learning reminder</h2></div></div>`);
            _push2(ssrRenderComponent(VDivider, null, null, _parent2, _scopeId));
            _push2(`<div class="learning-list" data-v-48fc2d5e${_scopeId}><!--[-->`);
            ssrRenderList(selfLearningItems, (item) => {
              _push2(`<div class="learning-item" data-v-48fc2d5e${_scopeId}><div class="learning-item__icon" aria-hidden="true" data-v-48fc2d5e${_scopeId}>`);
              _push2(ssrRenderComponent(VIcon, {
                icon: "ri-book-open-line",
                color: "primary",
                size: "16"
              }, null, _parent2, _scopeId));
              _push2(`</div><div class="learning-item__content" data-v-48fc2d5e${_scopeId}><span class="learning-item__title text-body-2 font-weight-medium" data-v-48fc2d5e${_scopeId}>${ssrInterpolate(item.title)}</span><span class="learning-item__meta text-caption" data-v-48fc2d5e${_scopeId}> Estimation: ${ssrInterpolate(item.estimate)}`);
              if (item.deadline) {
                _push2(`<!--[--> \xB7 Deadline: ${ssrInterpolate(item.deadline)}<!--]-->`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</span></div>`);
            ...
            return [
              createVNode("div", { class: "learning-card__header" }, [
                createVNode("div", { class: "learning-card__title-row" }, [
                  ...
                  createVNode("h2", { class: "text-body-1 text-high-emphasis font-weight-medium mb-0" }, "Self learning reminder")
                ])
              ]),
              createVNode(VDivider),
                    ...
                    createVNode("div", { class: "learning-item__content" }, [
                      ...
                      createVNode("span", { class: "learning-item__meta text-caption" }, [
                        ...
                        item.deadline ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                          createTextVNode(" \xB7 Deadline: " + toDisplayString(item.deadline), 1)
      ...
      _push(ssrRenderComponent(VCard, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="freshness-icon" data-v-48fc2d5e${_scopeId}>`);
            _push2(ssrRenderComponent(VIcon, {
              icon: "ri-refresh-line",
              color: "primary",
              size: "19"
            }, null, _parent2, _scopeId));
            _push2(`</div><div data-v-48fc2d5e${_scopeId}><p class="text-body-2 text-high-emphasis mb-1" data-v-48fc2d5e${_scopeId}>Risk signals refresh every Monday.</p><p class="text-caption text-medium-emphasis mb-0" data-v-48fc2d5e${_scopeId}>Your next watchlist review is ready.</p></div>`);
          } else {
            return [
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCardTitle, { class: "d-flex align-start justify-space-between gap-4 pa-6 pb-2" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      var _a, _b;
                      if (_push4) {
                        _push4(`<div data-v-48fc2d5e${_scopeId3}><span class="text-h5 text-high-emphasis" data-v-48fc2d5e${_scopeId3}>Follow up with ${ssrInterpolate((_a = unref(activeWatchlistItem)) == null ? void 0 : _a.name)}</span></div>`);
                  ...
                  _push3(ssrRenderComponent(VCardText, { class: "px-6 pt-3" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      var _a, _b;
                      if (_push4) {
                        _push4(`<div class="action-context mb-5" data-v-48fc2d5e${_scopeId3}>`);
                        ...
                        _push4(`<span class="text-body-2 text-medium-emphasis" data-v-48fc2d5e${_scopeId3}>${ssrInterpolate((_a = unref(activeWatchlistItem)) == null ? void 0 : _a.issue)}</span></div>`);
...
const dashboardTeacher = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-48fc2d5e"]]);
