...
import { aW as _export_sfc, a as VIcon, V as VBtn, b1 as VProgressLinear } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const selectedClassId = ref((_b2 = (_a2 = (_a = upcomingClasses.value.find((c) => c.status === "Ongoing")) == null ? void 0 : _a.id) != null ? _a2 : (_b = upcomingClasses.value[0]) == null ? void 0 : _b.id) != null ? _b2 : "");
    ...
    const getSupportColor = (status) => {
      var _a3;
      var _a22;
      return (_a3 = (_a22 = supportStatusMap[status]) == null ? void 0 : _a22.color) != null ? _a3 : "grey";
    };
    const getSupportLabel = (status) => {
      var _a3;
      var _a22;
      return (_a3 = (_a22 = supportStatusMap[status]) == null ? void 0 : _a22.label) != null ? _a3 : status;
    };
    const getPaceLabel = (pace) => {
      var _a3;
      var _a22;
      return (_a3 = (_a22 = paceMap[pace]) == null ? void 0 : _a22.label) != null ? _a3 : pace;
    };
    const getRatingLabel = (rating) => {
      var _a3;
      var _a22;
      return (_a3 = (_a22 = ratingMap[rating]) == null ? void 0 : _a22.label) != null ? _a3 : rating;
    };
                              ...
                              createVNode("div", { class: "d-flex align-start justify-space-between mb-2" }, [
                                ...
                                createVNode("div", { class: "text-right flex-shrink-0" }, [
                                  ...
                                  createVNode("span", {
                                    ...
                                    style: { color: `rgb(var(--v-theme-${(_b3 = (_b22 = paceMap[student.pace]) == null ? void 0 : _b22.color) != null ? _b3 : "warning"}))` }
                            ...
                            createVNode("div", {
                              ...
                              createVNode("div", { class: "d-flex align-start justify-space-between mb-2" }, [
                                ...
                                createVNode("div", { class: "text-right flex-shrink-0" }, [
                                  ...
                                  createVNode("span", {
                                    class: "text-caption font-weight-medium",
                                    style: { color: `rgb(var(--v-theme-${(_a3 = (_a22 = paceMap[student.pace]) == null ? void 0 : _a22.color) != null ? _a3 : "warning"}))` }
                                  }, toDisplayString(getPaceLabel(student.pace)), 5)
                                ])
                              ]),
                              createVNode("div", { class: "d-flex align-center justify-space-between gap-2" }, [
