import { toRef, computed, shallowRef, ref, createVNode, watch, withDirectives, Fragment, resolveDirective, provide, inject, mergeProps, toRaw, vShow, readonly } from 'vue';
import { V as VExpandTransition } from './index-CGI_inNZ.mjs';
import { q as genericComponent, t as provideTheme, x as useBackgroundColor, v as useBorder, W as useDensity, X as useDimension, y as useElevation, A as useRounded, F as provideDefaults, G as useRender, T as Ripple, $ as useLink, U as useVariant, ay as deprecate, a1 as genOverlays, a as VIcon, H as VDefaultsProvider, ac as useTextColor, C as useProxiedModel, ag as getCurrentInstance, av as focusChild, I as propsFactory, a2 as makeVariantProps, J as makeThemeProps, K as makeTagProps, L as makeRoundedProps, N as makeElevationProps, a7 as makeDimensionProps, S as makeDensityProps, P as makeComponentProps, Q as makeBorderProps, a9 as EventProp, af as getUid, R as IconValue, a3 as makeRouterProps, az as deepEqual, as as getPropertyFromItem, ar as omit, ab as wrapInArray, ax as defineComponent } from './server.mjs';
import { V as VAvatar, c as createSimpleFunctional, M as MaybeTransition } from './VAvatar-Bov4ZLUZ.mjs';
...
export { VList as V, VListItem as a, VListItemTitle as b, VListItemSubtitle as c, useItems as d, VListSubheader as e, makeItemsProps as m, useSsrBoot as u };
