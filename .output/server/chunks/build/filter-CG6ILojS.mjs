import { ref, computed, shallowRef, watch, createVNode, mergeProps, Fragment, createTextVNode, toRef, onScopeDispose, nextTick, watchEffect, unref } from 'vue';
import { u as useForm, V as VTextField, h as makeVTextFieldProps } from './VTextField-CQSxiXKB.mjs';
import { f as forwardRefs } from './forwardRefs-CtuH3aYe.mjs';
import { q as genericComponent, aa as useLocale, C as useProxiedModel, ab as wrapInArray, G as useRender, a as VIcon, ap as ensureValidVNode, H as VDefaultsProvider, aq as matchesSelector, ag as getCurrentInstance, X as useDimension, o as useToggleScope, m as convertToUnit, I as propsFactory, ar as omit, z as useDisplay, am as useResizeObserver, ao as debounce, an as clamp, a7 as makeDimensionProps, P as makeComponentProps, R as IconValue, as as getPropertyFromItem } from './server.mjs';
import { d as useItems, V as VList, a as VListItem, m as makeItemsProps } from './VList-MvyrR4cM.mjs';
import { V as VAvatar, m as makeTransitionProps } from './VAvatar-Bov4ZLUZ.mjs';
import { V as VMenu } from './VMenu-HR5UQDp_.mjs';
...
export { VSelect as V, useScrolling as a, VVirtualScroll as b, makeFilterProps as c, makeSelectProps as m, useFilter as u };
