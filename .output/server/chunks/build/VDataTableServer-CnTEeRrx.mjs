import { defineComponent, ref, computed, toRefs, toRef, provide, createVNode, mergeProps, Fragment, withCtx, unref, createTextVNode, withModifiers, shallowRef, watch, nextTick, Transition, resolveComponent, watchEffect, onScopeDispose, useSSRContext } from 'vue';
import { m as genericComponent, i as watchDebounced, o as propsFactory, E as provideDefaults, F as useRender, u as useNuxtApp, V as VBtn, q as useRtl, s as provideTheme, t as useBorder, v as useBackgroundColor, x as useElevation, y as useDisplay, z as useRounded, A as useRouter, B as useProxiedModel, C as toPhysical, l as useToggleScope, D as useLayoutItem, G as VDefaultsProvider, a as VIcon, H as makeThemeProps, I as makeTagProps, J as makeRoundedProps, K as makeLayoutItemProps, L as makeElevationProps, M as makeDisplayProps, N as makeComponentProps, O as makeBorderProps, k as convertToUnit } from './server.mjs';
...
import { u as useValidation, _ as _sfc_main$2, c as createAccountValidations } from './account-settings-CFMqtpMU.mjs';
import { PerfectScrollbar } from 'vue3-perfect-scrollbar';
import { u as useScopeId, a as useDelay, m as makeDelayProps } from './VOverlay-gAZb14KV.mjs';
import { u as useSsrBoot } from './VList-BNtS0p6J.mjs';
...
import { c as createGroupBy, b as createSort, d as createHeaders, u as useDataTableItems, p as provideSort, e as provideGroupBy, f as useGroupedItems, g as provideSelection, h as provideExpanded, i as useOptions, j as VDataTableHeaders, k as VDataTableRows, a as VTable, m as makeDataTableProps } from './VDataTable-TnWqeKKY.mjs';
import { c as createPagination, p as providePagination, V as VDataTableFooter, m as makeVDataTableFooterProps, a as makeDataTablePaginateProps } from './VDataTableFooter-BmXk9xgv.mjs';
